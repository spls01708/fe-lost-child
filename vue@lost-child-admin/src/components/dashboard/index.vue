    ...
    <div class="store-container">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
            ...
            <g id="ball">
                ...
                <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Fredoka One' font-size="34" fill="#0170BB"> Software-Center RTAF </text>
        ...
        <span style="font-size:10px;margin-top:20em;float:top;font-weight:bold;" class="text-primary">@Mariana Beldi : https://codepen.io/marianab/pens/public</span>    
    </div>
...
export default {
  ...
  data() {
    ...
    created () {
         ...
         let path = [ { text : 'AT' } ,{ text : 'Dashboard' } ] 
