  ...
  <div>
    ...
    <b-sidebar id="sidebar-1" title="Menu" shadow>
      <b-list-group class="rounded-0">
        <b-list-group-item active>หน้าแรก</b-list-group-item>
  ...
  <div>
      ...
      <b-card style="border:0px solid black;">
       ...
       <b-card-text style="text-align:center;">  
          ...
          <b-row class="mt-3">
            <b-col> 
                <b-button variant="outline-success rounded-0" style="border:2px solid;font-weight:bold;" size="lg" block @click="fn_search()">ค้นหา</b-button>
            </b-col>
          </b-row>
